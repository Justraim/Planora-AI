...
const FormSection: React.FC<{ title: string, children: React.ReactNode, delay?: string }> = ({ title, children, delay = '0s' }) => (
  <div className="space-y-6 pt-6 border-t border-gray-700/50 first:pt-0 first:border-none animate-fade-in-up" style={{ animationDelay: delay }}>
    ...
    <button type="button" onClick={onClick}
      className={`relative px-4 py-2 rounded-lg text-sm font-medium border transition-all duration-200 flex items-center gap-2 ${
        isSelected
          ...
          : 'bg-primary/20 border-gray-600 text-accent-soft hover:bg-accent/20 hover:text-white hover:border-accent/50'
      }`}
    >
  ...
  return (
    <>
      <div className="text-center mb-12 animate-fade-in-up">
        <h2 className="text-5xl font-bold text-accent-soft">Intelligent Trip Planning, Instantly</h2>
        <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto">Just share your travel preferences, and Itinerae AI will craft your perfect, personalized itinerary.</p>
      </div>
      <div className="max-w-4xl mx-auto bg-primary/50 backdrop-blur-xl p-6 md:p-10 rounded-2xl shadow-2xl shadow-black/20 border border-accent/20">
        <form onSubmit={onSubmit} className="space-y-8">
          ...
          <FormSection title="The Basics" delay="0.1s">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2 bg-primary/50 border border-gray-600 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent transition text-secondary"
                />
              </div>
              <div>
                <label htmlFor="destination" className="block text-sm font-medium text-gray-300 mb-1">What's your destination?</label>
                <input
              ...
              <div className="md:col-span-2">
                <label htmlFor="travelFrom" className="block text-sm font-medium text-gray-300 mb-1">Where are you travelling from?</label>
                <input
            ...
            <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">What's your preferred travel radius?</label>
          ...
          <FormSection title="Trip Details" delay="0.2s">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              ...
              <div>
                <label htmlFor="tripDuration" className="block text-sm font-medium text-gray-300 mb-1">How long is the trip? (days)</label>
                 <NumberStepper
                    id="tripDuration"
              ...
              <div>
                <label htmlFor="numberOfTravelers" className="block text-sm font-medium text-gray-300 mb-1">How many people are traveling?</label>
                <NumberStepper
              ...
              <div className="flex items-center justify-between">
                <label className="text-sm font-medium text-gray-300">Is this your first time there?</label>
                <ToggleSwitch 
          ...
          <FormSection title="Your Style" delay="0.3s">
            <div className="space-y-8">
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">What's the main purpose of your trip? (Select all that apply)</label>
                <div className="flex flex-wrap gap-2">
                ...
                {preferences.tripPurpose.includes('Other') && (
                  <div className="mt-4 animate-fade-in-up">
                    <label htmlFor="otherTripPurpose" className="block text-sm font-medium text-gray-300 mb-1">If other, please specify:</label>
                    <input
                      type="text"
                      id="otherTripPurpose"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">What are you most excited about? (Select at least one)</label>
                <div className="flex flex-wrap gap-2">
                 ...
                 <div className="mt-4">
                    <button
                      ...
                      className="w-full sm:w-auto flex items-center justify-center gap-2 bg-transparent text-accent font-semibold py-2 px-4 rounded-lg border-2 border-dashed border-accent/50 hover:bg-accent/10 hover:border-accent transition-all duration-300"
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <label className="block text-sm font-medium text-gray-300 mb-2">What's your preferred budget?</label>
                    <div className="flex flex-wrap gap-2">
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-300 mb-2">What's your ideal trip rhythm?</label>
                    <div className="flex flex-wrap gap-2">
            ...
            <div>
              <label htmlFor="specificInclusions" className="block text-sm font-medium text-gray-300 mb-1">Anything specific to include? (Optional)</label>
              <textarea
          ...
          <div className="pt-4 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <button
              ...
              className="w-full flex items-center justify-center bg-accent text-primary font-bold py-3 px-6 rounded-lg hover:bg-accent/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary focus:ring-accent transition-all duration-300 disabled:bg-accent/60 disabled:text-primary/70 disabled:cursor-not-allowed shadow-lg shadow-accent/20 hover:shadow-xl hover:shadow-accent/30"
            >
              {isLoading ? (
                'Generating...'
              ) : (
